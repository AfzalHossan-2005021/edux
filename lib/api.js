 ...
 * @param {string} endpoint - The API endpoint (e.g., '/api/auth/student/login')
 ...
 * @param {string} endpoint - The API endpoint
 * @param {object|FormData} data - Request body data. Can be plain object (JSON) or FormData (files)
 * @param {object} options - Additional fetch options
 * @returns {Promise<Response>}
 */
export const apiPost = async (endpoint, data = {}, options = {}) => {
  ...
  // If data is FormData, we send it as multipart/form-data
  if (data instanceof FormData) {
    body = data;  // DO NOT set Content-Type for FormData; browser sets it automatically
