 ...
 * @param {Function|string} keyGenerator - Function to generate cache key or static key string
 * @param {number} ttl - Time to live in seconds (default: CacheTTL.MEDIUM)
